...
public class AdminRoleController {
  ...
  public ResponseEntity<ApiResponse<RoleDetail>> detail(@PathVariable Long id) {
  ...
  public ResponseEntity<ApiResponse<RoleDetail>> update(@PathVariable Long id, @RequestBody RoleUpdateRequest req) {
  ...
  public ResponseEntity<Void> setMenus(@PathVariable Long id, @RequestBody AssignRoleMenusRequest req) {
  ...
  public ResponseEntity<Void> setPermissions(@PathVariable Long id, @RequestBody AssignRolePermissionsRequest req) {
